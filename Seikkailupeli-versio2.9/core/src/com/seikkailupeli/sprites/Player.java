...
public class Player extends Sprite {
    ...
    public enum State{STANDING, WALKINGUP, WALKINGDOWN, WALKINGRIGHT, WALKINGLEFT, WALKINGUPDIRECTION, WALKINGDOWNDIRECTION, WALKINGRIGHTDIRECTION, WALKINGLEFTDIRECTION}
