...
public class Player extends Sprite {
    ...
    public Player(int x,int y, World world){
        ...
        walkingDown = new com.badlogic.gdx.graphics.g2d.Animation<TextureRegion>(0.18f, walkFrames);
        ...
        walkingUp = new com.badlogic.gdx.graphics.g2d.Animation<TextureRegion>(0.1f, walkFrames2);
        ...
        walkingRight = new com.badlogic.gdx.graphics.g2d.Animation<TextureRegion>(0.16f, walkFrames3);
        ...
        walkingLeft = new com.badlogic.gdx.graphics.g2d.Animation<TextureRegion>(0.16f, walkFrames4);
